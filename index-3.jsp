    ...
    <head>
        ...
        <script>
            ...
            function dropMarker(latLngB) {
                ...
                distanceWithMarker1 = google.maps.geometry.spherical.computeDistanceBetween(map.getCenter(), latLngB);
                ...
                if (distance < cityCircle.getRadius()) {
                    ...
                    google.maps.event.addListener(marker, 'click', function() {
                         ...
                         */
                        //lopStore();
                        //cityCircle.setRadius(previousCircleRadius);
                    });
            ...
            marker = ["marker/centre.png", "fa220f", "e1ff00", "ff9100"];
            function markerList() {
                //the list of marker
                ...
                for (var i = 0; i < marker.length; i++) {
                    ...
                    if (i === 0) {
                        ...
                        div.innerHTML += '<img src="' + marker[i] + '" height="50px" width="50"/>' + '<div style="display: table-cell;vertical-align: middle;">' + value[i] + '</div>';
                    } else {
                        ...
                        div.innerHTML += '<img src="' + path + marker[i] + '" height="40px" width="25"/>' + '<div style="display: table-cell;vertical-align: middle;">' + value[i] + '</div>';
                    }
